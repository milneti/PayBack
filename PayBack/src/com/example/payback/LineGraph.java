...
public class LineGraph {
	...
	public Intent getTwoLineIntent(Context context, TimeSeries series1, TimeSeries series2, String title) {	
		XYMultipleSeriesDataset dataset = new XYMultipleSeriesDataset();
		dataset.addSeries(series1);
		dataset.addSeries(series2);
		
		Intent intent = createTwoLineIntent(context, dataset, title);
		return intent;
		
	}

	public Intent createTwoLineIntent(Context context, XYMultipleSeriesDataset dataset, String title) {		
		XYMultipleSeriesRenderer mRenderer = new XYMultipleSeriesRenderer(); // Holds a collection of XYSeriesRenderer and customizes the graph
		XYSeriesRenderer renderer = new XYSeriesRenderer(); // This will be used to customize line 1
...
/************************************* 
 * Test functions. For reference only
 ************************************/

...
CREATE TABLE IF NOT EXISTS `Notification` (
  `NoteID` INT(16) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
  `SendID` INT(8) UNSIGNED ZEROFILL NOT NULL,
  `ReceiveID` INT(8) UNSIGNED ZEROFILL NOT NULL,
  `TransID` INT(16) UNSIGNED ZEROFILL,
